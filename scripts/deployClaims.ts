...
async function main() {
  ...
  const claimAddress = "0x63fCec80C67d96002C4f4770247677F96D7b44f0"
...
// //   await Claims.registerCar("Toyota","Corolla",1998,10000,"123ABC");
...
//   const makePayment = await Claims.makePayment();
//   console.log("Payment succesfull, You have been insured!");
  
//   const startClaim = await Claims.startClaim("John",4,3,25);
...
//   const flowDetails = await Claims.connect(user1).flowDetails();
